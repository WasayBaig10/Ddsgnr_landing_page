  ...
  return (
    <div>
      ...
      <div className="w-[92vw] sm:w-[90vw] flex flex-col sm:flex-row h-fit ml-auto mr-auto m-4 items-center justify-between text-center sm:text-start space-y-9 sm:space-y-0">
        ...
        <div className="w-[92vw] sm:w-[96vw] h-fit m-4 items-center justify-center text-center sm:text-start">
          <ul className="flex justify-around sm:flex-row flex-col sm:space-y-0 space-y-10 ">
            <li className="ml-auto mr-auto sm:ml-0 sm:mr-0">
              <svg
                width="131"
                height="42"
                viewBox="0 0 131 42"
            ...
            <li className="space-y-5 ">
              <h6 className="font-bold">Courses</h6>
            ...
            <li className="space-y-5 ">
              <h6 className="font-bold">Resourses</h6>
              <div className="space-y-3">
                <li>Career</li>
                <li>Resume</li>
                <li>Learning</li>
                <li>Interwiew Preperation</li>
                <li>Jobs</li>
              </div>
            </li>
            <li className="space-y-5">
        ...
        <div className="w-[80vw] h-fit ml-auto bg-slate-300 mr-auto m-10 p-10 border-t-2 border-black ">
          <ul className="flex sm:justify-between w-[90%] sm:flex-row items-center text-center flex-col space-y-6 sm:space-y-0 justify-center">
            <li className="flex justify-around space-x-5  flex-col sm:flex-row space-y-4 sm:space-y-0">
              <h6>2023 Ddsgnr.All rights reserved</h6>
